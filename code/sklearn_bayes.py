...
def load_data(dirTrain, dirTest):
    train_df = pd.read_csv(f"feature_data/{dirTrain}/featureInput_noChampionRole.csv")
    test_df = pd.read_csv(f"feature_data/{dirTest}/featureInput_noChampionRole.csv")
...
def returnModel(X_train, X_test, y_train, y_test):
    gnb = generateModel(X_train, X_test, y_train, y_test)
    return gnb
...
def __init__(self):
    ...
    X_train, X_test, y_train, y_test = load_data(dirTrain, dirTest)
    generateModel(X_train, X_test, y_train, y_test)
